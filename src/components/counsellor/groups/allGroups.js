...
export default class AllGroups extends React.Component {
  ...
  getGroups = (limit, offset, filter) => {
    ...
    UserService.getAllGroups(limit1, offset, filter)
      .then((resp) => {
        if (resp) {
        ...
        <div className="page-breadcrumb">
                <div className="row">
                    <div className="col-md-12 align-self-center">
                        <h3 className="page-title text-truncate text-dark font-weight-medium mb-1">Groups</h3>
                        <div className="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb m-0 p-0">
                                    <li className="breadcrumb-item"><Link to={'/home'} className="text-muted">Home</Link></li>
                                    <li className="breadcrumb-item text-muted active" aria-current="page"><Link to={'/home/all-groups'} className="breadcrumb-item text-muted active">All Groups</Link></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              <div className="modal-header">
                <h4 className="modal-title">All Groups</h4>
                <button
                  type="button"
                  className="close"
                  id="close1"
