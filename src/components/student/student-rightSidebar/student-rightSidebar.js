...
import "./styles.css";
// require("./custom.js")
export default class StudentRightSide extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      activityList:[],
  ...
  render() {
    ...
    return (
      <div className="col-xl-3 col-lg-4  p-0 siebarmain calendar-widget">
        <div id="sticky-sidebar" className="widget-area">
          <div className="widget widget-peru-posts-thumb">
            ...
            {activityList.map((data,key)=>(
            <article key={key} className="item">
              <a className="thumb">
                <span  role="img"><img src={data?data.created_by?data.created_by.profile_img?URL+"/"+data.created_by.profile_img:'':'':''} onError={(e) => {
              ...
              <div className="info">
                ...
                {data?data.created_by?data.created_by.first_name?data.created_by.first_name:'':'':''} {data?data.activity_description:""}
                </h4>
                <time dateTime="2019-06-30">  <Moment fromNow>
                                            {data.created_at}
                                          </Moment></time>
              </div>
          ...
          <div className="widget widget-peru-posts-thumb overflownone">
            <div className='schedule-control-section calendar-picker-sidebar'>
                <div className='control-section'>
                    <div className='control-wrapper drag-sample-wrapper'>
                        <div className="schedule-container smallcalender">
                            <ScheduleComponent ref={schedule => this.scheduleObj = schedule} width='100%' height='650px' selectedDate={new Date()} readonly={true} eventSettings={{ dataSource: this.dataManger }} dataBinding={this.onDataBinding.bind(this)}>
                                <ViewsDirective>
