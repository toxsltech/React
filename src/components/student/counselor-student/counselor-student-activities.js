...
// import "../../admin/admin-counsellorList/node_modules/react-confirm-alert/src/react-confirm-alert.css"; // Import css
// import apibase from "../../globals/config";

// let serveUrl = apibase;

export default class StudentActivities extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      add_activity: false,
                        ...
                        <div className="card">
                          ...
                          <div className="collapsed">
                            <div className="card-body">
                              ...
                              <div className="form-group">
                                <label>
                                  I intend to participate in a similar activity
                                  in college.
                                </label>
                                <div>
                                  <span>
        ...
        <div className="page-breadcrumb">
                <div className="row">
                    <div className="col-md-12 align-self-center">
                        <h3 className="page-title text-truncate text-dark font-weight-medium mb-1">Extra Curricular Activities</h3>
                        <div className="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol className="breadcrumb m-0 p-0">
                                    <li className="breadcrumb-item"><Link to={'/home'} className="text-muted">Home</Link></li>
                                    <li className="breadcrumb-item text-muted active" aria-current="page"><Link to={'/home/extra-curricular'} className="breadcrumb-item text-muted active">Activities</Link></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
              ...
              {view == "Student" ? (
                activity_array.length <= 0 ? (
                  ...
                  <div>
                    ...
                    {showMain == "show" ? (
                      <div className="modal" id="viewactivitiy" data-backdrop="static">
                      <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                          ...
                          <div className="table-responsive">
                            <table className="table table-striped text-left">
                              <tbody>
                                ...
                                <tr>
                                  <th>
                                    Please describe this activity, including
                                    what you accomplished and any recognition
                                    you received, etc.
                                  </th>
                                  <td className="text-right">
                                    {" "}
                                ...
                                <tr>
                                  <th>
                                    {" "}
                                    I intend to participate in a similar
                                    activity in college.
                                  </th>
                                  <td className="text-right">
                                    {" "}
                ...
                <div className="card-body">
                  <p>
                    ...
                    your life outside of the classroom. Examples of activities
                    might include:
                  </p>
                  <div className="about-title mb-3">
                    <ul className="mb-0">
                      <li>
                        <i className="flaticon-right-arrow"></i> Arts or music
                      </li>
                      <li>
                      ...
                      {activity_array.map((data, index) => (
                        ...
                        data-target="#viewactivities"
                            ...
                            <div className="rightdata">
                              <button type="button" className="edit-btn default-btn ">
                                <i
                              ...
                              <button type="button" className="edit-btns default-btn student-btn">
                                <i
